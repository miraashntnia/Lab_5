...
2. Membuat Menu Tambah Data dengan source code sebagai berikut:
```
...
3. Membuat Menu Ubah Data dengan source code sebagai berikut:
```
...
4. Membuat Menu Hapus Data dengan source code sebagai berikut:
```
...
5. Membuat Menu Tampilkan data dengan source code sebagai berikut:
```
...
6. Membuat Menu Cari Data dengan source code sebagai berikut:
```
...
7. Membuat Menu Keluar dari program dengan source code sebagai berikut:
```
